...
int main(){
	...
	JAM2_analyzer.OutputFile = Form("/gpfs01/star/pwg/fliu/Lambda_PP_Mechanism/Lambda_PP_Mechanism_FIXTARGET/src/JAM2_sqrt_sNN_%.2f_40M_6.root",JAM2_analyzer.sqrt_sNN);
	JAM2_analyzer.Loop();
	return 0;
