...
void JAM2_TreeMarker_FIXTARGET(){
	...
	for(int i =0 ; i < 1000;i++){
	  Infiles.push_back(Form("/gpfs01/star/scratch/fengliu/sqrt_sNN_3p0_batch8/JAM2_sqrt_SNN_3p0_%d.dat",i));
	}
	...
	TFile *fout_stat = new TFile("/gpfs01/star/scratch/fengliu/JAM2/sqrt_sNN_3p0_root/stat_bacth8.root","RECREATE");
